        ...
        >
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-wrap gap-x-5 gap-y-2">
              {[
                { href: 'https://x.com/gizdusumandnode', label: '@gizdusumandnode' },
                { href: 'https://x.com/baybaginsss', label: '@baybaginsss' },
              ].map(({ href, label }) => (
                <a
                  key={label}
                  href={href}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-1 font-mono text-2xs transition-colors"
                  style={{ color: 'var(--ink-2)' }}
